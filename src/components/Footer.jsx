export default function Footer() {
  return (
    <footer className="text-center py-8 pb-20 text-sm text-gray-400 bg-black/50 border-t-4 border-dashed border-yellow-500 relative z-10">
      ...
      <p className="mt-2 text-gray-600">
        <span className="animate-blink">🔨 Webmaster : Morgane (ne lui envoyez pas de mails, il ne répond qu'aux fax) 🔨</span>
      </p>
